...
| `profile_id` | Input, generated profile-ID width | Core reset accepts the generated direct-profile ID, the [loader profile](../cartridge/MAS_loader_profile.md#core-reset-sequencing-and-image-validity) ID and the [MBC1 profile](../cartridge/MAS_mbc1_profile.md#reset-and-image-validity) ID; all apply every generated CPU register/control field of the direct entry state. An unknown ID is a named contract failure; it cannot select a test state. |
