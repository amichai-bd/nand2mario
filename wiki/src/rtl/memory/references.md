...
- [Pan Docs OAM corruption](https://github.com/gbdev/pandocs/blob/fe246067b695b5404a4a6a47efb4fd6d921ececb/src/OAM_Corruption_Bug.md), same pin/license: FEA0–FEFF can trigger corruption despite having no ordinary store; the [DMA owner](../dma/MAS_dma.md) applies it.
