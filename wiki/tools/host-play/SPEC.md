...
The host-play target permits 1500 seconds of wall time and 500 ms of simulation time. The declared frame-wait callback permits 300 seconds; serial-response progress retains 120 seconds and the Client wire timeout remains in simulated time. These host limits cover full ROM load/readback, five snapshot downloads and the original 800000-dot sequence. They do not change the game, pixel or frame-freshness expectations. Ordinary simulation targets retain their 600-second maximum.
