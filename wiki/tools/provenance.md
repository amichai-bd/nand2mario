...
The SDRAM controller for the [game library](../src/project-charter.md#game-library)
is a ported import: [`n2m_sdram_pkg.sv`](../../src/rtl/storage/n2m_sdram_pkg.sv)
and [`n2m_sdram_ctrl.sv`](../../src/rtl/storage/n2m_sdram_ctrl.sv) come from
