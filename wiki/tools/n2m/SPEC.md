...
|---|---|
| 12125, exact `v05-board` generated PLL, RAM, decode, and mux inventory under the attempt `db/` directory | Quartus 25.1 selects all 17 retained generated design units although the generated QSF does not list those database files. Classification requires the exact basenames, message text, one-design-unit/entity counts, complete inventory, and regular files in the owned attempt database. A missing, duplicate, relocated, renamed, or additional 12125 warning fails. |
