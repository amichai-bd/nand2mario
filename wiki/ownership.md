...
| [Software oracle](../tools/n2m/rgbds.py) and [tools/sw provenance](../tools/sw/THIRD_PARTY.md) | [PRD](tools/sw/PRD.md) | [SPEC](tools/sw/SPEC.md) | [Oracle tests](../tools/n2m/tests/test_rgbds.py), [original fixtures](../src/sw/oracle/encoding.asm); later conformance [#85–#88](tools/sw/SPEC.md#delivery-order) |
