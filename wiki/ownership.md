...
| [src/rtl/storage](../src/rtl/storage/n2m_sdram_ctrl.sv) and [src/dv/storage](../src/dv/storage/README.md), SDRAM controller and device model; planned flash reader and boot copier ([#658](https://github.com/amichai-bd/nand2mario/issues/658)) | [Charter game library](src/project-charter.md#game-library) | [MAS_sdram](src/rtl/storage/MAS_sdram.md), [MAS_flash_library](src/rtl/storage/MAS_flash_library.md) | [SDRAM test plan](../src/dv/storage/README.md), [SDRAM fixtures and assertions](src/rtl/storage/MAS_sdram.md#verification), [flash fixtures and assertions](src/rtl/storage/MAS_flash_library.md#verification) |
