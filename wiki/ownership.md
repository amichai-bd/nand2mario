...
| [tools/sw assembler](../tools/sw/assembler.py) and [software oracle](../tools/n2m/rgbds.py) | [PRD](tools/sw/PRD.md) | [SPEC](tools/sw/SPEC.md) | [Assembler tests](../tools/n2m/tests/test_assembler.py), [oracle tests](../tools/n2m/tests/test_rgbds.py), [full matrix](../tools/sw/conformance.py); later integration [#86–#88](tools/sw/SPEC.md#delivery-order) |
