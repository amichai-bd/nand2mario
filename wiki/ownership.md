...
|---|---|---|---|
| [tools/n2m](../tools/n2m/cli.py) and its [tools/build.py](../tools/build.py) dispatcher | [PRD](tools/n2m/PRD.md) | [SPEC](tools/n2m/SPEC.md) | [Host tests](../tools/n2m/tests/test_builder.py), [simulation registry and smoke](../src/dv/builder/targets.json) |
...
index; display is the only implemented RTL owner in this inventory. Verification
