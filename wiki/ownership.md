...
| [tools/n2m/springtrail_state.py](../tools/n2m/springtrail_state.py), [tools/n2m/springtrail_play.py](../tools/n2m/springtrail_play.py) and [tools/springtrail_player.py](../tools/springtrail_player.py) | [Host requirements](tools/n2m/host/PRD.md) | [Springtrail state reconstruction](tools/host-play/SPEC.md#springtrail-state-reconstruction) | [State](../src/dv/springtrail/test_state_reader.py), [play](../src/dv/springtrail/test_state_play.py) and [entrypoint](../src/dv/springtrail/test_state_player.py) checks against a model-driven fake endpoint |
...
| [tools/n2m](../tools/n2m/cli.py) and its [tools/build.py](../tools/build.py) dispatcher | [PRD](tools/n2m/PRD.md) | [SPEC](tools/n2m/SPEC.md) | [Host tests](../tools/n2m/tests/test_builder.py), [interface generator tests](../tools/n2m/tests/test_interfaces.py), [baseline report tests](../tools/n2m/tests/test_baseline.py), [regression and cleanup tests](../tools/n2m/tests/test_regress.py), [catalogue tests](../tools/n2m/tests/test_catalogue.py), [simulation registry and smoke](../src/dv/builder/targets.json), [test catalogue](../src/dv/builder/catalogue.yaml), [declared regression subsets](../src/dv/builder/regressions.json) |
...
| [src/rtl/storage](../src/rtl/storage/n2m_sdram_ctrl.sv) and [src/dv/storage](../src/dv/storage/README.md): SDRAM controller and device model, [flash reader](../src/rtl/storage/n2m_flash_reader.sv), [On-Chip Flash IP double](../src/rtl/storage/n2m_sim_onchip_flash.sv) and [boot copier](../src/rtl/storage/n2m_boot_copier.sv) | [Charter game library](src/project-charter.md#game-library) | [MAS_sdram](src/rtl/storage/MAS_sdram.md), [MAS_flash_library](src/rtl/storage/MAS_flash_library.md) | [Storage test plan](../src/dv/storage/README.md), [SDRAM fixtures and assertions](src/rtl/storage/MAS_sdram.md#verification), [flash fixtures and assertions](src/rtl/storage/MAS_flash_library.md#verification) |
| [src/rtl/cartridge](../src/rtl/cartridge/n2m_loader.sv) and [src/dv/cartridge](../src/dv/cartridge/README.md), loader profile | [Charter game library](src/project-charter.md#game-library) | [MAS_loader_profile](src/rtl/cartridge/MAS_loader_profile.md), [MAS_mbc1_profile](src/rtl/cartridge/MAS_mbc1_profile.md) | [Loader test plan](../src/dv/cartridge/README.md), [loader fixtures and assertions](src/rtl/cartridge/MAS_loader_profile.md#verification), [MBC1 fixtures and assertions](src/rtl/cartridge/MAS_mbc1_profile.md#verification) |
| [tools/sw/vga_bezel/directions.json](../tools/sw/vga_bezel/directions.json), the bezel art source | [Bezel directions](src/rtl/vga/BEZEL.md) | [Generated sources](tools/n2m/SPEC.md#vga-bezel-source-generation), [scanout border stage](src/rtl/vga/MAS_vga.md#border-selection) | [Generator tests](../tools/n2m/tests/test_vga_bezel_sources.py), [border oracle](../src/dv/vga/tb_vga_bezel.sv) |
