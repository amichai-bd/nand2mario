...
| `src/rtl/storage` and `src/dv/storage`, planned SDRAM controller, device model, flash reader and boot copier ([#658](https://github.com/amichai-bd/nand2mario/issues/658)) | [Charter game library](src/project-charter.md#game-library) | [MAS_sdram](src/rtl/storage/MAS_sdram.md), [MAS_flash_library](src/rtl/storage/MAS_flash_library.md) | [SDRAM fixtures and assertions](src/rtl/storage/MAS_sdram.md#verification), [flash fixtures and assertions](src/rtl/storage/MAS_flash_library.md#verification) |
