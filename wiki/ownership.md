...
| `src/rtl/cartridge`, planned loader profile ([#658](https://github.com/amichai-bd/nand2mario/issues/658)) | [Charter game library](src/project-charter.md#game-library) | [MAS_loader_profile](src/rtl/cartridge/MAS_loader_profile.md) | [Loader fixtures and assertions](src/rtl/cartridge/MAS_loader_profile.md#verification) |
