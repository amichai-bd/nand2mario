...
def validate(root, target):
    ...
    if target.get("preload") not in (None, "integration", "v05", "palette-fc", "palette-00", "startup-read", "startup-write", "vram-read", "vram-write", "late-fe9c", "late-fe9d", "late-fe20", "timer234", "dma239", "springtrail", "mooneye-reg-f"):
    ...
    if target.get("preload") in ("integration", "v05", "palette-fc", "palette-00", "startup-read", "startup-write", "vram-read", "vram-write", "late-fe9c", "late-fe9d", "late-fe20", "timer234", "dma239", "springtrail"):
...
def prepare(target, attempt, root=None, fixture_tools=None):
    ...
    if target.get("preload") in ("integration", "v05", "palette-fc", "palette-00", "startup-read", "startup-write", "vram-read", "vram-write", "late-fe9c", "late-fe9d", "late-fe20", "timer234", "dma239", "springtrail"):
        ...
        if target["preload"] in ("v05", "springtrail"):
