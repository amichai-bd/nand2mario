...
FIXTURE_BUILDERS = {
    ...
    **dict.fromkeys(("motion301", "motion301-s", "power302", "power302-s", "power302-a", "power302-b",
                     ...
                     "progress304-s", "progress304-a", "progress304-b", "entities305-s", "entities305-a", "entities305-b", "entities305-c", "entities305-d", "entities305-e", "entities305-f", "entities305-g", "entities305-h", "entities305-i", "entities-oam305-s", "entities-oam305-a", "entities-oam305-b", "entities-oam305-c"), "src/dv/springtrail/motion_program.py"),
...
def validate(root, target, name=None):
    ...
    if target.get("preload") in ("hud493-s", "hud493-a", "hud493-b", "hud493-c", "hud493-d", "hud493-e", "acquisition515-s", "acquisition515-a", "acquisition515-b", "acquisition515-c", "interaction494-s", "interaction494-a", "interaction494-b", "interaction494-c", "interaction494-d", "courier492-s", "courier492-a", "courier492-b", "courier492-c", "courier492-d", "courier492-e", "courier492-f", "courier492-g", "integration", "v05", "palette-fc", "palette-00", "startup-read", "startup-write", "vram-read", "vram-write", "late-fe9c", "late-fe9d", "late-fe20", "timer234", "stop349", "dma239", "display308", "oam299", "oam299-s", "courier292", "courier292-s", "hud300", "hud300-s", "hud-render300", "entities-render305", "entities-render305-changed", "motion301", "motion301-s", "motion-render301", "power302", "power302-s", "power302-a", "power302-b", "power-render302", "blocks303-s", "blocks303-a", "blocks303-b", "progress304-s", "progress304-a", "progress304-b", "entities305-s", "entities305-a", "entities305-b", "entities305-c", "entities305-d", "entities305-e", "entities305-f", "entities305-g", "entities305-h", "entities305-i", "entities-oam305-s", "entities-oam305-a", "entities-oam305-b", "entities-oam305-c", "springtrail", "springtrail-unit", "flow", "flow-s", "render", "render-s", "stackdrop", "stackdrop-unit", "stackdrop-short"):
        ...
        if target['preload'] in ('acquisition515-s', 'acquisition515-a', 'acquisition515-b', 'acquisition515-c', 'interaction494-s', 'interaction494-a', 'interaction494-b', 'interaction494-c', 'interaction494-d', 'motion301', 'motion301-s', 'power302', 'power302-s', 'power302-a', 'power302-b', 'blocks303-s', 'blocks303-a', 'blocks303-b',
            ...
            if target['preload'].startswith('acquisition515'):
