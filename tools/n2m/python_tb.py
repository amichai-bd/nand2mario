...
def validate(root, target):
    ...
    if target.get("preload") not in (None, "integration", "v05", "palette-fc", "palette-00", "startup-read", "startup-write", "vram-read", "vram-write", "late-fe9c", "late-fe9d", "late-fe20", "timer234", "dma239", "springtrail", "springtrail-unit", "flow", "flow-s", "stackdrop", "stackdrop-unit", "stackdrop-short", "mooneye-reg-f"):
    ...
    if target.get("preload") in ("integration", "v05", "palette-fc", "palette-00", "startup-read", "startup-write", "vram-read", "vram-write", "late-fe9c", "late-fe9d", "late-fe20", "timer234", "dma239", "springtrail", "springtrail-unit", "flow", "flow-s", "stackdrop", "stackdrop-unit", "stackdrop-short"):
        ...
        if target["preload"] in ("springtrail", "springtrail-unit", "flow", "flow-s", "stackdrop", "stackdrop-unit", "stackdrop-short"):
...
def prepare(target, attempt, root=None, fixture_tools=None):
    ...
    if target.get("preload") in ("integration", "v05", "palette-fc", "palette-00", "startup-read", "startup-write", "vram-read", "vram-write", "late-fe9c", "late-fe9d", "late-fe20", "timer234", "dma239", "springtrail", "springtrail-unit", "flow", "flow-s", "stackdrop", "stackdrop-unit", "stackdrop-short"):
        ...
        if target["preload"] in ("v05", "springtrail", "springtrail-unit", "flow", "flow-s", "stackdrop", "stackdrop-unit", "stackdrop-short"):
