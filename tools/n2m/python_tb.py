...
FIXTURE_BUILDERS = {
    ...
    **dict.fromkeys(("motion301", "motion301-s", "power302", "power302-s", "power302-a", "power302-b",
                     ...
                     "progress304-s", "progress304-a", "progress304-b", "entities305-s", "entities305-a", "entities305-b", "entities305-c", "entities305-d", "entities305-e", "entities305-f", "entities305-g", "entities305-h", "entities-oam305-s", "entities-oam305-a", "entities-oam305-b", "entities-oam305-c"), "src/dv/springtrail/motion_program.py"),
    ...
    **dict.fromkeys(("entities-render305", "entities-render305-changed"), "src/dv/springtrail/entities_render_program.py"),
...
def validate(root, target, name=None):
    ...
    if target.get("preload") in ("integration", "v05", "palette-fc", "palette-00", "startup-read", "startup-write", "vram-read", "vram-write", "late-fe9c", "late-fe9d", "late-fe20", "timer234", "stop349", "dma239", "display308", "oam299", "oam299-s", "courier292", "courier292-s", "hud300", "hud300-s", "hud-render300", "entities-render305", "entities-render305-changed", "motion301", "motion301-s", "motion-render301", "power302", "power302-s", "power302-a", "power302-b", "power-render302", "blocks303-s", "blocks303-a", "blocks303-b", "progress304-s", "progress304-a", "progress304-b", "entities305-s", "entities305-a", "entities305-b", "entities305-c", "entities305-d", "entities305-e", "entities305-f", "entities305-g", "entities305-h", "entities-oam305-s", "entities-oam305-a", "entities-oam305-b", "entities-oam305-c", "springtrail", "springtrail-unit", "flow", "flow-s", "render", "render-s", "stackdrop", "stackdrop-unit", "stackdrop-short"):
        ...
        if target['preload'] in ('motion301', 'motion301-s', 'power302', 'power302-s', 'power302-a', 'power302-b', 'blocks303-s', 'blocks303-a', 'blocks303-b',
                                  'progress304-s', 'progress304-a', 'progress304-b', 'entities305-s', 'entities305-a', 'entities305-b', 'entities305-c', 'entities305-d', 'entities305-e', 'entities305-f', 'entities305-g', 'entities305-h', 'entities-oam305-s', 'entities-oam305-a', 'entities-oam305-b', 'entities-oam305-c'):
...
def prepare(target, attempt, root=None, fixture_tools=None):
    ...
    if target.get("preload") in ("integration", "v05", "palette-fc", "palette-00", "startup-read", "startup-write", "vram-read", "vram-write", "late-fe9c", "late-fe9d", "late-fe20", "timer234", "stop349", "dma239", "display308", "oam299", "oam299-s", "courier292", "courier292-s", "hud300", "hud300-s", "hud-render300", "entities-render305", "entities-render305-changed", "motion301", "motion301-s", "motion-render301", "power302", "power302-s", "power302-a", "power302-b", "progress304-s", "progress304-a", "progress304-b", "entities305-s", "entities305-a", "entities305-b", "entities305-c", "entities305-d", "entities305-e", "entities305-f", "entities305-g", "entities305-h", "entities-oam305-s", "entities-oam305-a", "entities-oam305-b", "entities-oam305-c", "power-render302", "blocks303-s", "blocks303-a", "blocks303-b", "progress304-s", "progress304-a", "progress304-b", "entities305-s", "entities305-a", "entities305-b", "entities305-c", "entities305-d", "entities305-e", "entities305-f", "entities305-g", "entities305-h", "entities-oam305-s", "entities-oam305-a", "entities-oam305-b", "entities-oam305-c", "springtrail", "springtrail-unit", "flow", "flow-s", "render", "render-s", "stackdrop", "stackdrop-unit", "stackdrop-short"):
        ...
        if target["preload"] in ("v05", "springtrail", "springtrail-unit", "flow", "flow-s", "render", "render-s", "stackdrop", "stackdrop-unit", "stackdrop-short"):
            ...
            name=target['preload']
            suite=('entities_oam' if name.startswith('entities-oam305') else 'entities' if name.startswith('entities305') else 'progress' if name.startswith('progress304') else 'blocks' if name.startswith('blocks303')
                   else 'power' if name.startswith('power302') else 'motion')
            part=name[-1] if name.endswith(('-a','-b','-c','-d','-e','-f','-g','-h')) else None
