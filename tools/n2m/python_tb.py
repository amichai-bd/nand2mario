...
def validate(root, target):
    ...
    if target.get("preload") not in (None, "integration", "v05", "palette-fc", "palette-00", "startup-read", "startup-write", "vram-read", "vram-write", "late-fe9c", "late-fe9d", "late-fe20", "timer234", "dma239", "springtrail", "springtrail-unit", "stackdrop", "stackdrop-unit", "mooneye-reg-f"):
    ...
    if target.get("preload") in ("integration", "v05", "palette-fc", "palette-00", "startup-read", "startup-write", "vram-read", "vram-write", "late-fe9c", "late-fe9d", "late-fe20", "timer234", "dma239", "springtrail", "springtrail-unit", "stackdrop", "stackdrop-unit"):
        ...
        if target["preload"] in ("springtrail", "springtrail-unit", "stackdrop", "stackdrop-unit"):
...
def prepare(target, attempt, root=None, fixture_tools=None):
    ...
    if target.get("preload") in ("integration", "v05", "palette-fc", "palette-00", "startup-read", "startup-write", "vram-read", "vram-write", "late-fe9c", "late-fe9d", "late-fe20", "timer234", "dma239", "springtrail", "springtrail-unit", "stackdrop", "stackdrop-unit"):
        ...
        if target["preload"] in ("v05", "springtrail", "springtrail-unit", "stackdrop", "stackdrop-unit"):
