...
class BudgetTests(unittest.TestCase):
    ...
    def test_shipped_targets_declare_only_measured_allowances(self):
        # Only the measured motion, power, pause, entity and v0.5 continuity fixtures declare one; every
        ...
        self.assertEqual(sorted(declared), ['python-entity-render-changed', 'python-entity-render-normal', 'python-mgu', 'python-mr', 'python-pgu', 'python-pgx', 'python-pr', 'python-v05-continuity'])
