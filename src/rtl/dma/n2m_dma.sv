...
module n2m_dma (
    ...
    n2m_memory_pkg::memory_store_t direct_store;
    ...
    n2m_oam_pkg::oam_effect_t effect_kind;
    ...
    assign local_owner=owner_destination==n2m_memory_pkg::MEMORY_DMA || owner_destination==n2m_memory_pkg::MEMORY_OAM ||
        owner_destination==n2m_memory_pkg::MEMORY_VRAM || owner_destination==n2m_memory_pkg::MEMORY_UNUSABLE;
    assign local_memory=owner_destination==n2m_memory_pkg::MEMORY_OAM || owner_destination==n2m_memory_pkg::MEMORY_VRAM;
    assign local_allowed=owner_destination==n2m_memory_pkg::MEMORY_VRAM ? vram_cpu_allow :
        ((oam_cpu_allow || (owner_write && oam_cpu_late_write)) && !dma_active);
    assign late_prepare=owner_prepare && owner_destination==n2m_memory_pkg::MEMORY_OAM && owner_write && !dma_active;
    assign late_commit=owner_commit && owner_destination==n2m_memory_pkg::MEMORY_OAM && owner_write
    ...
    always_comb begin
        ...
        if(owner_destination==n2m_memory_pkg::MEMORY_DMA) begin owner_rdata=page; owner_valid=1; end
        else if(owner_destination==n2m_memory_pkg::MEMORY_UNUSABLE) begin
    ...
    assign service_cpu_store=redirect_write ? n2m_memory_pkg::STORE_VRAM : direct_store;
    ...
    n2m_dma_service service (.oam_request, .oam_response, .clk_sys(clk_sys), .reset(reset), .init_done(init_done && !fault && !invalid_observation),
        ...
        .oam_sequence_active, .late_future(oam_late_future), .late_prepare(late_prepare), .late_commit(late_commit),
    ...
    assign raw_vram_read=ppu_vram_request && !reset && !fault &&
        !(access_write && access_store==n2m_memory_pkg::STORE_VRAM && access_address[12:0]==ppu_vram_address);
    ...
    assign raw_oam_read=ppu_oam_phase!=0 && !dma_active && !reset && !fault &&
        !(access_write && access_store==n2m_memory_pkg::STORE_OAM && access_address[7:1]==ppu_oam_pair) &&
