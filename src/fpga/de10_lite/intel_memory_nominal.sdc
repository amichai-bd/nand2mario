...
set_input_delay -clock [get_clocks {*pll1|clk*}] -max 2.000 [get_ports {frame_read frame_address*}]
set_input_delay -clock [get_clocks {*pll1|clk*}] -min 0.000 [get_ports {frame_read frame_address*}]
