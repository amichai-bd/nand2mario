...
set_input_delay -clock [get_clocks {u_clocking|u_system_pll|altpll_component|auto_generated|pll1|clk*}] -max 2.000 [get_ports {board_reset_n uart_rx buttons_n*}]
set_input_delay -clock [get_clocks {u_clocking|u_system_pll|altpll_component|auto_generated|pll1|clk*}] -min 0.000 [get_ports {board_reset_n uart_rx buttons_n*}]
