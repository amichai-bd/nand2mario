...
module tb_dma_late;
    ...
    integer index, case_index, checks;
    logic [15:0] target;
    ...
    initial begin
        ...
        oam_cpu_late_write=0; oam_late_future=0; checks=0;
        ...
        for(case_index=0;case_index<4;case_index=case_index+1) begin
            ...
            repeat(3) dot_step(); ppu_scan_index=39; oam_cpu_late_write=1;
        ...
        if(checks!=9) $fatal(1,"DMA_LATE_COUNTS");
        $display("PASS DMA late owner checks=9");$finish;
    end
