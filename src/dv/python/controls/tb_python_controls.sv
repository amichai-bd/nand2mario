...
module tb_python_controls;
    ...
    defparam dut.u_system.u_stores.rom.INIT_FILE = "preload-rom.mif";
    defparam dut.u_system.u_uart.u_commands.u_load.u_presence.u_presence.INIT_FILE = "preload-presence.mif";
