...
def main():
    ...
    parser.add_argument('--case', choices=('integration','palette-fc','palette-00','springtrail-short','springtrail'), default='integration')
    ...
    try:
        ...
        image_contract=case['image'] if springtrail else case['images'][args.case] if case else manifest['image']
